...
class QuestionsAdder extends Component {
	...
	constructor(props) {
		...
		this.checkIfMaximumLimitReached = this.checkIfMaximumLimitReached.bind(this);
	}
	...
	render() {
		...
		return (
			<section className='quesstions-adder clearfix'>
				<Row>
					<Col sm={6}>
						<h3>Create your Questionnair</h3>
					</Col>
					<Col sm={6}>
						<button className='btn add-btn' onClick={this.addQuestionFunc}><i className='fas fa-plus'></i> Add New Qsuestion</button>
					</Col>
				</Row>
				<MsgModal
		          size='sm'
